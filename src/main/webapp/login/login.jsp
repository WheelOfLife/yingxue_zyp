...
/*表单验证*/
        $.extend($.validator.messages, {
            required: "<span style=' color: #d9534f' >这是必填字段</span>",
        ...
        $("#loginButtonId").click(function () {
            ...
            if (valid){
                ...
                $.ajax({
                    ...
                    type:"post",
                    data:$("#loginForm").serialize(),//表单数据 序列化 ；；根据name属性
                    success:function (data) {
                      if(data.status=="200"){
                          ...
                          //展示错误信息
                        $("#msgDiv").html("<span style='color:red'>"+data.massage+"</span>")
                      }
                    }
                })
            }
                    ...
                    <div class="form-bottom" style="width: 450px">
                        <form role="form" action="" method="post" class="login-form" id="loginForm">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="name" placeholder="请输入用户名..." class="form-username form-control" required id="form-username" minlength="4">
                            </div>
                            <div class="form-group">
                                <label class="sr-only" for="form-password">Password</label>
                                <input type="password" name="password" placeholder="请输入密码..." class="form-password form-control" required id="form-password" minlength="4">
                            </div>
                            <div class="form-group">
